...
Now let's check excluding the origin points, as before. If there are less than 15 points to plot, we will decrease the number of neighbors to the number of points -1;
